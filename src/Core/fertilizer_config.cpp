...
const Fertilizer FertilizerConfig::fertilizers_[COUNT] = {
    ...
    {"NPK Base", "NPK", PUMP_1_NPK_BASE_PIN, 10, true, 0},
    {"Micro Nutrients", "Micro", PUMP_2_MICRO_PIN, 5, true, 1},
    {"pH Down", "pH-", PUMP_3_PH_DOWN_PIN, 2, true, 2},
    {"Bloom Booster", "Bloom", PUMP_4_BLOOM_PIN, 8, true, 3},
    {"Water", "H2O", PUMP_5_WATER_PIN, 50, false, 4}};
